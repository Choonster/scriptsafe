...
(function (t) {
  t.fn.stickyScroll = function (o, ...args) {
    var e = {
      init: function (this: JQuery<unknown>, o: StickyScrollOptions) {
        function e() {
          return (
            t(document).height() -
            i.container.offset().top -
            Number(i.container.attr('offsetHeight'))
          );
        }
        function s() {
          return i.container.offset().top;
        }
        function n(o: JQuery<unknown>) {
      ...
      reset: function (this: JQuery<unknown>) {
    ...
    return typeof o === 'string' && e[o]
      ...
      : 'object' != typeof o && o
        ...
        : e.init.apply(this, [o as StickyScrollOptions]);
  };
})(jQuery);
